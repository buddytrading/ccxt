...
//  ---------------------------------------------------------------------------
import { find, isEmpty, takeRight } from "lodash";
import WebSocketClient from "../base/ws/WebsocketClient.js";
 ...
 * @augments Exchange
 */
export class yellow extends Exchange {
  describe() {
  ...
  async watchOHLCV(symbol, timeframe = "1m", params = {}) {
    ...
    const kline = `${_convertBaseExchange(base)}${_convertQuoteExchange(
      quote
    )}.kline-${timeframe}`;
